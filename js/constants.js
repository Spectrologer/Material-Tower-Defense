...
export const ENEMY_TYPES = {
    ...
    BOSS: { speed: 1.2, health: 4400, armor: 10, color: '#f589ffff', size: 28, gold: 50, icon: 'flutter_dash', iconFamily: 'Material Icons', isFlying: true, damagesLives: false, laysEggs: true, layEggInterval: 5, eggLayStopTime: 1.5, wiggleTime: 1, splashImmune: true, comment: "Has commitment issues.", musicTrack: SpecialTrack.flutterDash },
    ...
    SUMMONER: { speed: 0.5, health: 150, armor: 10, color: '#4ade80', size: 22, gold: 3, icon: 'hub', iconFamily: 'Material Symbols Outlined', damagesLives: true, spawnsMinions: true, spawnInterval: 3, spawnCount: 5, spawnDelay: 1, minionType: 'MINION', comment: "Division of labor." },
    MINION: { speed: 3.5, health: 10, armor: 0, color: '#4ade80', size: 5, gold: 0, icon: 'attribution', iconFamily: 'Material Symbols Outlined', damagesLives: true, comment: "Just following orders." }
};
