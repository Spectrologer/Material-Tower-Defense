...
export const TOWER_TYPES = {
    ...
    PIN_HEART: { cost: 85, range: 175, damage: 0.8, fireRate: 10, color: '#ff69b4', projectileSpeed: 5, projectileSize: 3, projectileColor: '#ff69b4', splashRadius: 0, special: 'Loyal Projectiles', comment: "It's a little clingy." },
