...
export const TOWER_TYPES = {
    ...
    PIN_HEART: { cost: 85, range: 250, damage: 1.3, fireRate: 10, color: '#ff69b4', projectileSpeed: 4, projectileSize: 3, projectileColor: '#ff69b4', splashRadius: 0, special: 'Homing Projectiles' },
...
export const ENEMY_TYPES = {
    ...
    FLYING: { speed: 2.0, health: 15, color: '#9a67ea', size: 16, gold: 2, icon: 'helicopter', iconFamily: "'Material Symbols Outlined'", isFlying: false }
};
