...
export const TOWER_TYPES = {
    ...
    NINE_PIN: { cost: 119, range: 249, damage: 9, fireRate: 29, color: '#FFFFFF', projectileSpeed: 9, projectileSize: 39, projectileColor: '#ffffffff', splashRadius: 0, special: 'Piercing Shot', unmergeable: true },
};
...
export const ENEMY_TYPES = {
    ...
    BOSS: { speed: 1.2, health: 4400, color: '#f589ffff', size: 28, gold: 50, icon: 'flutter_dash', iconFamily: 'Material Icons', isFlying: true, damagesLives: false, laysEggs: true, layEggInterval: 300, eggLayStopTime: 90, wiggleTime: 60, splashImmune: true },
