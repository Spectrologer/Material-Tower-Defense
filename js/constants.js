...
export const ENEMY_TYPES = {
    ...
    HEAVY: { speed: 1.1, health: 35, armor: 5, color: '#2c60b5ff', size: 20, gold: 3, icon: 'guardian', iconFamily: 'Material Symbols Outlined', damagesLives: true, comment: "Slow and steady loses the race." },
    HEALER: { speed: 1.8, health: 20, armor: 3, color: '#0e87beff', size: 18, gold: 5, icon: 'digital_wellbeing', iconFamily: 'Material Symbols Outlined', damagesLives: true, isHealer: true, healInterval: 2.5, healRange: 80, healPercent: 0.10, comment: "Sharing is caring." },
