...
export const TOWER_TYPES = {
    ...
    CASTLE: { cost: 75, range: 100, damage: 6, fireRate: 60, color: '#525252ff', projectileSpeed: 5, projectileSize: 6, projectileColor: '#ff9900', splashRadius: 50, comment: "It's like a house, but for rocks." },
    FORT: { cost: 100, range: 200, damage: 12, fireRate: 180, color: '#878787ff', projectileSpeed: 4, projectileSize: 15, projectileColor: '#717171ff', splashRadius: 80, special: 'Mortar Strike', comment: "Bigger rocks. Angrier rocks." },
    SUPPORT: { cost: 60, range: 100, damage: 0, fireRate: 0, color: '#f870ffff', attackSpeedBoost: 0.85, special: 'Non-Stacking Speed Aura', comment: "Probably listening to motivational podcasts." },
    PIN_HEART: { cost: 85, range: 250, damage: 0.8, fireRate: 10, color: '#ff69b4', projectileSpeed: 5, projectileSize: 3, projectileColor: '#ff69b4', splashRadius: 0, special: 'Loyal Projectiles', comment: "It's a little clingy." },
    FIREPLACE: { cost: 135, range: 50, damage: 0.1, fireRate: 2, color: '#e11d48', projectileSpeed: 3, projectileSize: 8, projectileColor: '#ff6600', splashRadius: 45, burnDps: 2, burnDuration: 20, special: 'Lingering Burn', comment: "Cozy, with a chance of third-degree burns." },
...
export const ENEMY_TYPES = {
    ...
    FAST: { speed: 2.5, health: 8, color: '#ffb84d', size: 14, gold: 1, icon: 'pest_control_rodent', iconFamily: 'Material Icons', damagesLives: true, comment: "Has places to be. Your base isn't one of them." },
    ...
    BOSS: { speed: 1.2, health: 4400, color: '#f589ffff', size: 28, gold: 50, icon: 'flutter_dash', iconFamily: 'Material Icons', isFlying: true, damagesLives: false, laysEggs: true, layEggInterval: 5, eggLayStopTime: 1.5, wiggleTime: 1, splashImmune: true, comment: "Lays eggs. Has commitment issues." },
