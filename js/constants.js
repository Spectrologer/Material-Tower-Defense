...
export const TOWER_TYPES = {
    ...
    ANTI_AIR: { cost: 110, range: 350, damage: 70, fireRate: 170, color: '#a9a9a9', projectileSpeed: .1, projectileSize: 24, projectileColor: '#cccccc', special: 'Air units only', comment: "Causes severe turbulence." },
};
...
export const ENEMY_TYPES = {
    ...
    HATCHED: { speed: 2.8, health: 150, color: '#90CAF9', size: 14, gold: 0, icon: 'boy', iconFamily: 'Material Symbols Outlined', damagesLives: true, comment: "Why." },
