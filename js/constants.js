...
export const TOWER_TYPES = {
    PIN: { cost: 25, range: 150, damage: 1.5, fireRate: 22, color: '#ffffffff', projectileSpeed: 7, projectileSize: 3, projectileColor: '#00ff88', splashRadius: 0 },
    ...
    PIN_HEART: { cost: 85, range: 250, damage: 1.5, fireRate: 10, color: '#ff69b4', projectileSpeed: 3, projectileSize: 3, projectileColor: '#ff69b4', splashRadius: 0, special: 'Homing Projectiles' },
...
export const ENEMY_TYPES = {
    ...
    HEAVY: { speed: 1, health: 30, color: '#0018ccff', size: 20, gold: 3, icon: 'guardian', iconFamily: 'Material Symbols Outlined', splashImmune: true },
