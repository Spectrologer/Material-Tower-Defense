...
export const ENEMY_TYPES = {
    ...
    BOSS: { speed: 1.2, health: 4400, armor: 10, color: '#f472b6', size: 33, gold: 50, icon: 'flutter_dash', iconFamily: 'Material Icons', isFlying: true, damagesLives: false, laysEggs: true, layEggInterval: 5, eggLayStopTime: 1.5, wiggleTime: 1, splashImmune: true, comment: "Big fan of Birdo.", musicTrack: SpecialTrack.flutterDash },
    EGG: { speed: 0, health: 200, armor: 2, color: '#fbcfe8', size: 15, gold: 0, icon: 'egg', iconFamily: 'Material Symbols Outlined', damagesLives: false, hatchTime: 5, hatchesTo: 'HATCHED', isStationary: true, comment: "Great, another mobile gacha game" },
