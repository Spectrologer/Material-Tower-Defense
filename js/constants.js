...
export const ENEMY_TYPES = {
    NORMAL: { speed: 1.5, health: 12, armor: 0, color: '#dc2626', size: 16, gold: 1, icon: 'person', iconFamily: 'Material Icons', damagesLives: true, comment: "Just some guy. Don't feel too bad." },
    ...
    HEAVY: { speed: 1.1, health: 35, armor: 5, color: '#1c5abeff', size: 20, gold: 3, icon: 'guardian', iconFamily: 'Material Symbols Outlined', damagesLives: true, comment: "Slow and steady loses the race.", filled: true },
    HEALER: { speed: 1.5, health: 20, armor: 3, color: '#0e87beff', size: 18, gold: 5, icon: 'digital_wellbeing', iconFamily: 'Material Symbols Outlined', damagesLives: true, isHealer: true, healInterval: 2.5, healRange: 80, healPercent: 0.10, comment: "Sharing is caring.", filled: true },
    FLYING: { speed: 2.0, health: 15, armor: 0, color: '#8846c5ff', size: 16, gold: 2, icon: 'helicopter', iconFamily: 'Material Symbols Outlined', isFlying: true, splashImmune: true, damagesLives: true, comment: "Ignores ground rules. And your ground towers.", filled: true },
    ...
    BOSS: { speed: 1.2, health: 4400, armor: 10, color: '#f472b6', size: 33, gold: 50, icon: 'flutter_dash', iconFamily: 'Material Icons', isFlying: true, damagesLives: false, laysEggs: true, layEggInterval: 5, eggLayStopTime: 1.5, wiggleTime: 1, splashImmune: true, comment: "Big fan of Birdo.", musicTrack: SpecialTrack.flutterDash, filled: true },
    EGG: { speed: 0, health: 200, armor: 2, color: '#fbcfe8', size: 15, gold: 0, icon: 'egg', iconFamily: 'Material Symbols Outlined', damagesLives: false, hatchTime: 5, hatchesTo: 'HATCHED', isStationary: true, comment: "Great, another mobile gacha game", filled: true },
    ...
    PARAGLIDING: { speed: 0.8, health: 25, armor: 0, color: '#a7f3d0', size: 18, gold: 2, icon: 'paragliding', iconFamily: 'Material Symbols Outlined', damagesLives: true, isFlying: true, ignoresPath: true, comment: "Doesn't follow the rules of the road.", filled: true },
};
