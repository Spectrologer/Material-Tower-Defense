...
export const ENEMY_TYPES = {
    ...
    HEAVY: { speed: 1.1, health: 35, armor: 5, color: '#3b82f6', size: 20, gold: 3, icon: 'guardian', iconFamily: 'Material Symbols Outlined', damagesLives: true, comment: "Slow and steady loses the race." },
    HEALER: { speed: 1.8, health: 20, armor: 3, color: '#0ea5e9', size: 18, gold: 5, icon: 'digital_wellbeing', iconFamily: 'Material Symbols Outlined', damagesLives: true, isHealer: true, healInterval: 2.5, healRange: 80, healPercent: 0.10, comment: "Sharing is caring." },
    FLYING: { speed: 2.0, health: 15, armor: 0, color: '#a855f7', size: 16, gold: 2, icon: 'helicopter', iconFamily: 'Material Symbols Outlined', isFlying: true, splashImmune: true, damagesLives: true, comment: "Ignores ground rules. And your ground towers." },
    ...
    BITCOIN: { speed: 2.0, health: 20, armor: 0, color: '#facc15', size: 15, gold: 0, icon: 'currency_bitcoin', iconFamily: 'Material Symbols Outlined', isFlying: false, splashImmune: false, damagesLives: false, comment: "Volatile. Will drain your assets." },
