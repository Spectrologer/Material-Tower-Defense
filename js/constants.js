...
export const ENEMY_TYPES = {
    ...
    SUMMONER: { speed: 0.5, health: 150, armor: 10, color: '#4ade80', size: 22, gold: 3, icon: 'hub', iconFamily: 'Material Symbols Outlined', damagesLives: true, spawnsMinions: true, spawnInterval: 3, spawnCount: 5, spawnDelay: 1, minionType: 'MINION', comment: "Alienated labor." },
